  ...
  <nav className={`${styles.root} ${location.pathname === '/' ? styles.atHome : ''}`}>
    ...
    <ul>
      <li className={styles.home}>
        <Link pathname="/" className={styles.linkHome} activeRoute={activeRoute} onClick={onClick}>
      ...
      <li>
        <Link pathname="/jobs" search={location.search} className={styles.linkJobs} activeRoute={activeRoute} onClick={onClick}>
      ...
      <li>
        <Link pathname="/create-job" className={styles.linkCreateJob} activeRoute={activeRoute} onClick={onClick}>
      ...
      <li>
        <Link pathname="/product-lines" className={styles.linkProductLines} activeRoute={activeRoute} onClick={onClick}>
      ...
      <li>
        <Link pathname="/create-product-line" className={styles.link} activeRoute={activeRoute} onClick={onClick}>
      ...
      <li>
        <Link pathname="/help" className={styles.linkHelp} onClick={onClick}>
